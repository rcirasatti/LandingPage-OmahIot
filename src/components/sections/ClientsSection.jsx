      ...
      <div className="container mx-auto text-center relative">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <div className="inline-block relative mb-4">
            <span className="block text-[hsl(148,41%,58%)] font-medium text-lg mb-3 animate-fade-in">TRUSTED BY INDUSTRY LEADERS</span>
              ...
              <div className="flex logos-slide animate-infinite-scroll">
                {logos.map((logo, index) => (
                  ...
                  >
                    ...
                    />
                    <div className="absolute bottom-2 left-0 right-0 text-center opacity-0 group-hover:opacity-100 transition-all duration-500 text-xs font-medium text-[hsl(210,72%,25%)]">{logo.alt}</div>
                  </div>
                ))}
