...
return (
    <section
    id="home"
    className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[hsl(210,72%,25%)] via-[hsl(148,41%,58%)]/20 to-[hsl(146,51%,91%)]"
    >
    <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('''/LandingPage-OmahIot/grid.svg''')] bg-center [mask-image:radial-gradient(white,transparent_85%)] opacity-20"></div>
    </div>
    ...
    <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-xl md:text-2xl font-medium mb-8 max-w-3xl mx-auto text-white/90 animate-fade-in-delay-1 leading-relaxed drop-shadow-md">
            ...
            <span className="text-[hsl(146,51%,91%)] font-semibold"> IoT </span>
            and
            <span className="text-[hsl(146,51%,91%)] font-semibold">
            {" "}
            Digital Innovation
            </span>
        </p>
